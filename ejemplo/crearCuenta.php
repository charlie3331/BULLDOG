...
if ($stmt->execute()) {
    mostrarMensaje("¡Felicidades, $usuario! Tu cuenta ha sido creada exitosamente.", "index.html", 2);
} else {
    mostrarMensaje("Hubo un error al crear tu cuenta: " . $stmt->error, "index.html");
}
